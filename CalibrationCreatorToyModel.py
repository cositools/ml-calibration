...
class CalibrationCreatorToyModel(GRBCreator):
  """
  This class represents calibration data set creator which uses a toy model simulation
  """
...
###################################################################################################
  ...
  def __init__(self, ResolutionInDegrees):
    ...
    CalibrationCreator.__init__(self)
